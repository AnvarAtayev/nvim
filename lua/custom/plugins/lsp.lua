      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local function client_supports_method(client, method, bufnr)
            if client.supports_method then return client:supports_method(method, bufnr)
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
            ...
            local function safe_document_highlight()
              ...
              for _, c in ipairs(clients) do
                if client_supports_method(c, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
